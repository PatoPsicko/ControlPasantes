...
<div class="mb-8 flex items-center gap-4">
    ...
    <h1 class="text-3xl font-bold text-gray-900">Registrar Practicante</h1>
</div>
        ...
        <div class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="university" id="university" value="{{ old('university') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="request_number" id="request_number" value="{{ old('request_number') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2" required>
                </div>
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" value="{{ old('phone') }}" placeholder="0000-0000" pattern="\d{4}-\d{4}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="dui" id="dui" value="{{ old('dui') }}" placeholder="00000000-0" pattern="\d{8}-\d{1}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2" required>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="birth_date" id="birth_date" value="{{ old('birth_date') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="max_hours" id="max_hours" value="{{ old('max_hours') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2" required min="1">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="assigned_unit" id="assigned_unit" value="{{ old('assigned_unit') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="supervisor_name" id="supervisor_name" value="{{ old('supervisor_name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2" required>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="start_date" id="start_date" value="{{ old('start_date') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="end_date" id="end_date" value="{{ old('end_date') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="schedule" id="schedule" value="{{ old('schedule') }}" placeholder="De 08:00 AM a 12:00 PM" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 border p-2">
                </div>
            </div>
